...
var nft_contract = 'royalties.evin.testnet'; //'dev-1646240406152-71422260461975' //change this line to 'process.env.nft_contract' to access the env variable from file,
...
var marketplace_contract = 'market.evin.testnet'; //No changes done to the main one
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/warstelide49", "/.near/validator_key.json"),
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 7;
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.nftContract, {
          ...
          case 7:
            window.nft_contract = _context.sent;
            _context.next = 10;
            return new _nearApiJs.Contract(window.walletConnection.account(), 'market.evin.testnet', {
              viewMethods: ['get_supply_sales', 'get_supply_by_owner_id', 'get_sales_by_nft_contract_id', 'get_supply_by_nft_contract_id', 'storage_balance_of'],
              changeMethods: ['offer', 'storage_deposit', 'storage_withdraw']
            });

          case 10:
            window.marketplace_contract = _context.sent;
...
var GAS_FEE = "100000000000000";
var NEAR_IN_YOCTO = 1000000000000000000000000;

var _getConfig = (0, _config.default)('development'),
    networkId = _getConfig.networkId;

var submitButton = document.querySelector('form button'); //mint

document.getElementById('mint_form').onclick = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var button, d, tokenId, title, description, media;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 11:
            _context.prev = 11;
            _context.next = 14;
            return window.nft_contract.nft_mint({
              "token_id": tokenId,
              "metadata": {
                "title": title,
...
document.getElementById('find-token').onclick = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
    var button, result, account;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            button = event.target;
            button.disabled = true;
            account = document.getElementById("account-id").value;
            _context2.prev = 3;
            _context2.next = 6;
            return window.nft_contract.nft_tokens_for_owner({
              account_id: account,
              limit: 10
            });
...
function tokenModal(result) {
  ...
  modal.querySelector("#transfer").addEventListener("click", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var button, receiver_id, token_id, approved_account_id, _i;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              button = event.target;
              button.disabled = true;
              receiver_id = modal.querySelector("#receiver").value;
              token_id = modal.querySelector("#token_id").value;
              approved_account_id = 0;

              for (_i = 0; _i < result.length; _i++) {
                if (result[_i].token_id == token_id) {
                  if (window.accountId in result[_i].approved_account_ids) {
                    approved_account_id = result[_i].approved_account_ids[window.accountId];
                  }
                }
              }
              ...
              _context3.prev = 6;
              _context3.next = 9;
              return window.nft_contract.nft_transfer({
...
function populateSales() {
  return _populateSales.apply(this, arguments);
}

function _populateSales() {
  _populateSales = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var sales_content, sales, token_ids, tokens, i, token, container;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            sales_content = document.getElementById('sales_content');
            _context8.prev = 1;
            _context8.next = 4;
            return window.marketplace_contract.get_sales_by_nft_contract_id({
          ...
          case 4:
            ...
            token_ids = sales.map(function (sale) {
              return sale.token_id;
            });
            tokens = [];
            i = 0;

          case 8:
            if (!(i < token_ids.length)) {
              _context8.next = 16;
              break;
            }

            _context8.next = 11;
            return window.nft_contract.nft_token({
          ...
          case 16:
            container = createSalesDOM(sales, tokens);
...
function createSaleFromObject(sale, token) {
  var saleDOM = document.createElement('div');
  saleDOM.id = "sale";
  saleDOM.innerHTML = "<div>\n                  <img src=".concat(token.metadata.media, " style=\"height:300px;width:auto;\">\n                  <button id=\"buy_sale\">Buy!</button> \n                  <h3>Price:").concat((sale.sale_conditions / 1000000000000000000000000).toFixed(2), "</h3>\n                  </div>");
  var button = saleDOM.querySelector('button');
...
function _buy() {
  _buy = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(e) {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            _context9.prev = 3;
            _context9.next = 6;
            return window.marketplace_contract.offer({
              "nft_contract_id": "royalties.evin.testnet",
              "token_id": e.target.token_id
            }, "300000000000000", e.target.price);
...
document.getElementById('deposit_storage').onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
  var amount, deposit;
  return regeneratorRuntime.wrap(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          amount = parseFloat(document.getElementById('storage_amount').value);
        ...
        case 4:
          ...
          deposit = (amount * NEAR_IN_YOCTO).toLocaleString('fullwide', {
            useGrouping: false
          });
          _context4.prev = 6;
          _context4.next = 9;
          return window.marketplace_contract.storage_deposit({}, "300000000000000", deposit);
...
document.getElementById('check_balance').onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
  var storage_content, result;
  return regeneratorRuntime.wrap(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          storage_content = document.getElementById('storage_content');
          _context5.prev = 1;
          _context5.next = 4;
          return window.marketplace_contract.storage_balance_of({
            "account_id": window.accountId
          });

        case 4:
          result = _context5.sent;
          storage_content.textContent = "".concat((result / Math.pow(10, 24)).toFixed(2), " NEAR");
          _context5.next = 12;
          break;
...
document.getElementById('withdraw_storage').onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _context6.next = 3;
          return window.marketplace_contract.storage_withdraw({}, "300000000000000", "1");
...
document.getElementById('approve_for_marketplace').onclick = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(event) {
    var button, tokenId, sale_price, sale_conditions;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            button = event.target;
            button.disabled = true;
            tokenId = document.getElementById("approval_token_id").value;
          ...
          case 8:
            ...
            sale_conditions = (sale_price * NEAR_IN_YOCTO).toLocaleString('fullwide', {
              useGrouping: false
            });
            _context7.prev = 10;
            _context7.next = 13;
            return window.nft_contract.nft_approve({
              "token_id": tokenId,
              "account_id": "market.evin.testnet",
              //Using the contract name explicitly
              "msg": JSON.stringify({
